$(function () {
    ...
    var initSettingsForm = function (chartType, brand, dimensions) {
        ...
        $.getJSON("/analyt-query-builder/codebase/widget-adapter/" + chartType + "/" + brand + "/widgetOptions.json", function (defaultWidgetOptions) {
            ...
            if (currentCodeLanguage === defaultCodeLanguage) {
                $.getJSON("/analyt-query-builder/codebase/widget-adapter/" + chartType + "/" + brand + "/widgetOptionsRu.json", function (defaultWidgetOptionsRu) {
